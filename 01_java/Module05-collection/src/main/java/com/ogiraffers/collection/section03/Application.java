package com.ogiraffers.collection.section03;
...
/*
    ...
    *   - hash 테이블과 함께 이중 연결 리스트를 가지고 있으며 이를 통해 다음번 연결값의 순서를 알 수 있게 된다.
    *   - 즉, hash테이블과 이중 연결 리스트를 함께 사용하는 방식이다.
    *
    * 3. treeSet
    ...
    *   - 정렬된 데이터를 필요로 할 떄 유용하며, 범위 검색과 같은 작업을 쉽게 수행할 수 있다.
