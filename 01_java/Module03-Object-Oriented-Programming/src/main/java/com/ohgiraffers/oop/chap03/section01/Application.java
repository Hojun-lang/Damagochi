...
/*
* 상속
*  - 상속은 객체지향 프로그램의 핵심 개념 중 하나로, 기존 클래스(부모 또는 슈퍼 클래스)의 속성(필드)와 기능(메서드)를
...
public class Application {
    public static void main(String[] args) {
        ...
        * 2. 변경 사항이 생기면 모든 클래스에서 일일히 수정해야 한다
        * 3. 유지보수성이 낮아진다.
        */
        ...
        * 2. 상속을 통해 중복된 속성과 기능은 재정의가 필요 없어지게 되며, chargeBattery기능만 추가하면 된다.
        */
