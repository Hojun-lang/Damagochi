...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
        * 문제점 :
        * 1. 데이터가 흩어져 있다. : brand1, model1, speed1은 논리적으로 하나의 묶음이지만, 코드상으로 뿔뿔이 흩어져 있따.
        * 2. 관리의 어려움 : 자동차가 100대가 되면, 100개의 브랜드, 100개의 모델, 100개의 속도 변수를 모두 따로 관리해야 한다.
        ...
        * -new Car()는 "car설계도를 보고 실제 자동차를 한 대 생산해" 라는 의미이다.
        *
        * myCar변수 (참조 변수)
        * -myCar는 방금 만들어진 car객체가 메모리 어디에 있는지 주소(참조)를 저장하는 변수이다.
        ...
        */
        ...
        /*
        * 인스턴ㄱ스 참조
        * -myCar는 Car객체의 주소를 지니고 있으며 '.'(참조 연산자)는 이것을 '참조한다' 라고 한다.
        * -myCar를 통해 객체의 속석(brand, model, speed)나 기능(accelerate, brake)를 사용할 수 있다.
        */
